...
- (void)loadView {
    ...
    [self.navigationBar setBackgroundImage:[UIImage imageWithColor:UIColorFromHex(0x2e89f7) size:CGSizeMake(self.navigationBar.frame.size.width, self.navigationBar.frame.size.height + 20)]
    ...
    if ([UIDevice currentDevice].systemVersion.floatValue > 7.0) {
        //导航背景颜色
        self.navigationBar.barTintColor = UIColorFromHex(0x2e89f7);
    }
